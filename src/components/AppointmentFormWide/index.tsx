...
const AppointmentFormWide = () => {
  return (
    <div
      className={"bg-white py-14 mt-10 drop-shadow-[0_0_10px_rgba(0,0,0,0.1)]"}
    >
      ...
      >
        Your personal information will not be passed on to any third parties.
        please read our <span className={"font-semibold"}>Privacy Policy</span>.
      </p>
    </div>
  );
};

export default AppointmentFormWide;
