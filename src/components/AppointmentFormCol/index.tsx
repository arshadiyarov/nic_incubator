...
const AppointmentFromCol = () => {
  return (
    <form action="" className={"p-12 flex flex-col gap-3"}>
      <div className={"border border-other flex gap-3 p-3 w-[325px]"}>
        ...
        <input type="name" placeholder={"Name"} className={"outline-none"} />
      </div>
      <div className={"border border-other flex gap-3 p-3 w-[325px]"}>
        <svg
          width="24"
      ...
      <div className={"flex border border-other p-3 gap-3"}>
        <svg
          width="24"
          height="23"
          viewBox="0 0 24 23"
      ...
      <button
        className={
          "bg-otherSecond text-xs text-white font-bold font-manrope py-4 px-6"
        }
      >
        GET AN APPOINTMENT
      </button>
...
export default AppointmentFromCol;
